...
#   {repo_full_name}/{workspace_name}/{milestone_id}:latest
#
...
REPO_WS[dubbo]="baseline_rerun_stage4_002_fix2_v2"
...
REPO_WS[go-zero]="baseline_001_rerun_stage4_008_fix"
...
REPO_WS[nushell]="baseline_rerun_stage4_003_fixed_v2"
...
REPO_WS[scikit-learn]="baseline_001_rerun_stage4_002"
...
for repo in "${REPOS_TO_PROCESS[@]}"; do
    ...
    echo -e "  Local prefix: ${repo_full}/${ws}/"

    # Base image
    pull_and_retag \
        "${DOCKERHUB_ORG}/${repo}:base" \
        "${repo_full}/${ws}/base:latest"
